...
namespace HLSP_Launcher_for_yandi505
{
    public partial class BSSetup : Form
    {
        ...
        public BSSetup(MainController prevFormController)
        {
            InitializeComponent();
        ...
        async private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Process.Start(@".\\Half-Life\hl.exe", "-game bshift -noforcemparams +exec autoexec.cfg " + textBox1.Text);
                ...
                controller.updateRPC("Версия 1.1", "Играет в Half-Life: Blue Shift", "bs");
                timer1.Start();
            }
            else
            {
